				...
				value: function initPagination() {
					...
					if (!o.onlyInfoPagination) {
						...
						$pre.off('click').on('click', function (e) {
							if (_this6.options.pageNumber - 1 !== 0) {
								return _this6.onPagePre(e);
							}
						});
						$next.off('click').on('click', function (e) {
							// console.log(_this6.options.pageNumber)
							// console.log(_this6.options.totalPages)
							// console.log(_this6)
							if (_this6.options.pageNumber  !== _this6.options.totalPages) {
